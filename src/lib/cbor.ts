// cbor.js converted to ES module

const POW_2_24 = 5.960464477539063e-8;
const POW_2_32 = 4294967296;
const POW_2_53 = 9007199254740992;

export function encode(value: any): string | Uint8Array {
    ...
    let retView = new DataView(ret.buffer);
    for (let i = 0; i < offset; ++i) retView.setUint8(i, dataView.getUint8(i));
    return ret;
}

export function decode(data: Uint8Array, tagger?: any, simpleValue?: any): any {
    let dataView = new DataView(data.buffer);
    let offset = 0;
    if (typeof tagger !== "function") tagger = (value) => value;
    if (typeof simpleValue !== "function") simpleValue = () => undefined;
